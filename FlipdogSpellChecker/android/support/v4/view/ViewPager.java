...
public class ViewPager extends ViewGroup
{
  ...
  private void computeCurrentVelocity(VelocityTracker paramVelocityTracker, int paramInt, float paramFloat)
  {
    paramVelocityTracker.computeCurrentVelocity(paramInt);
  }
  ...
  public void endFakeDrag()
  {
    ...
    computeCurrentVelocity(localVelocityTracker, 1000, this.mMaximumVelocity);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (true)
    {
      ...
      break label240;
      label407: ItemInfo localItemInfo = infoForChild(localView);
    ...
    for (int i7 = 0; ; i7++)
    {
      if (i7 >= i6)
      {
        ...
        if (localView1.getVisibility() != 8)
        {
          ...
          {
            int n = 0x7 & localLayoutParams1.gravity;
            int i1 = 0x70 & localLayoutParams1.gravity;
            Log.d("ViewPager", "gravity: " + localLayoutParams1.gravity + " hgrav: " + n + " vgrav: " + i1);
            int i2 = -2147483648;
            i3 = -2147483648;
            if ((i1 == 48) || (i1 == 80))
              break label316;
            ...
            label267: if (i4 == 0)
              break label328;
            i2 = 1073741824;
            label277: localView1.measure(View.MeasureSpec.makeMeasureSpec(i, i2), View.MeasureSpec.makeMeasureSpec(j, i3));
            if (i4 == 0)
              break label341;
      ...
      if (localView2.getVisibility() != 8)
      {
        ...
        if ((localLayoutParams2 == null) || (!localLayoutParams2.isDecor))
          localView2.measure(this.mChildWidthMeasureSpec, this.mChildHeightMeasureSpec);
      }
    }
  }
  ...
  void populate()
  {
    if (this.mAdapter == null)
      break label7;
    label7: label144: label531: label535: 
    while (true)
    {
      return;
      if ((!this.mPopulatePending) && (getWindowToken() != null))
      {
        ...
        label187: View localView1;
        if (n >= this.mItems.size())
        {
          if (this.mItems.size() <= 0)
            break label455;
          i2 = ((ItemInfo)this.mItems.get(-1 + this.mItems.size())).position;
          if (i2 < k)
          {
            i7 = i2 + 1;
            if (i7 <= j)
          ...
          if (localItemInfo2 == null)
            break label525;
          localObject = localItemInfo2.object;
          localPagerAdapter.setPrimaryItem(this, i5, localObject);
          this.mAdapter.finishUpdate(this);
          if (!hasFocus())
            break;
        ...
        for (ItemInfo localItemInfo3 = infoForAnyChild(localView1); ; localItemInfo3 = null)
        {
          ...
          for (int i6 = 0; ; i6++)
          {
            ...
            ItemInfo localItemInfo4 = infoForChild(localView2);
            if ((localItemInfo4 != null) && (localItemInfo4.position == this.mCurItem) && (localView2.requestFocus(2)))
              break;
          }
          label306: break label7;
          ItemInfo localItemInfo1 = (ItemInfo)this.mItems.get(n);
          if (((localItemInfo1.position < j) || (localItemInfo1.position > k)) && (!localItemInfo1.scrolling))
          {
            this.mItems.remove(n);
            n--;
            this.mAdapter.destroyItem(this, localItemInfo1.position, localItemInfo1.object);
          }
          while (true)
          {
            ...
            n++;
            break;
            if ((m < k) && (localItemInfo1.position > j))
            {
              int i1 = m + 1;
              if (i1 < j)
                i1 = j;
              while ((i1 <= k) && (i1 < localItemInfo1.position))
              {
                addNewItem(i1, n);
                i1++;
                n++;
          ...
          label461: i7 = j;
          break label135;
          label467: addNewItem(i7, -1);
          i7++;
          break label135;
          label480: if (((ItemInfo)this.mItems.get(i3)).position == this.mCurItem)
          {
  ...
  void setCurrentItemInternal(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      break label60;
      label215: ((ItemInfo)this.mItems.get(j)).scrolling = bool;
      j++;
      break label91;
      label238: bool = false;
    }
    label244: if ((bool) && (this.mOnPageChangeListener != null))
      this.mOnPageChangeListener.onPageSelected(paramInt1);
    if ((bool) && (this.mInternalPageChangeListener != null))
      this.mInternalPageChangeListener.onPageSelected(paramInt1);
    completeScroll();
