...
public class SimpleCursorAdapter extends ResourceCursorAdapter
{
  ...
  public void bindView(View paramView, Context paramContext, Cursor paramCursor)
  {
    ...
    while (true)
    {
      j++;
      break;
      label129: if (!(localView instanceof ImageView))
        break label151;
      setViewImage((ImageView)localView, str);
    }
    label151: throw new IllegalStateException(localView.getClass().getName() + " is not a " + " view that can be bounds by this SimpleCursorAdapter");
  }
