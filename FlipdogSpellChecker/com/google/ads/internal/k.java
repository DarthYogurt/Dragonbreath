    ...
    implements GestureOverlayView.OnGesturePerformedListener
  {
    ...
    public void onGesturePerformed(GestureOverlayView paramGestureOverlayView, Gesture paramGesture)
    {
      ...
      while ((((Prediction)localArrayList.get(0)).score <= 2.0D) || (!"debug".equals(((Prediction)localArrayList.get(0)).name)) || (this.c == null))
        return;
      if (this.c.c() == null);
      for (final String str = "[No diagnostics available]"; ; str = this.c.c())
      {
        new AlertDialog.Builder(this.b).setMessage(str).setTitle("Ad Information").setPositiveButton("Share", new DialogInterface.OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
          {
            k.a.b(k.a.this).startActivity(Intent.createChooser(new Intent("android.intent.action.SEND").setType("text/plain").putExtra("android.intent.extra.TEXT", str), "Share via"));
          }
        }).setNeutralButton("Report", new DialogInterface.OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
          {
            new Thread(new j(k.a.a(k.a.this).d(), k.a.b(k.a.this).getApplicationContext())).start();
          }
