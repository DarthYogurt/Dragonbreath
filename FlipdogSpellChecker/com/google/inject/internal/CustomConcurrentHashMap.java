...
final class CustomConcurrentHashMap
{
    ...
    implements ConcurrentMap<K, V>, Serializable
  {
    ...
    public boolean containsValue(Object paramObject)
    {
      ...
      int i5;
      int i6;
      label39: boolean bool1;
      if (i < 2)
      {
        i5 = 0;
        i6 = 0;
        if (i6 < arrayOfSegment.length)
        {
      ...
      void expand()
      {
        ...
        if (k < i)
        {
          ...
          while (true)
          {
            k++;
            break;
            label127: Object localObject3 = localObject1;
            int n = m;
 ...
 * Qualified Name:     com.google.inject.internal.CustomConcurrentHashMap
