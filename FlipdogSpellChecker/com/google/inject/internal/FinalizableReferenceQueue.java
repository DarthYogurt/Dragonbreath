...
public class FinalizableReferenceQueue
{
    ...
    implements FinalizableReferenceQueue.FinalizerLoader
  {
    ...
    URL getBaseUrl()
      throws IOException
    {
      String str1 = "com.google.inject.internal.Finalizer".replace('.', '/') + ".class";
      ...
      return new URL(str2.substring(0, str2.length() - str1.length()));
    }
    ...
    public Class<?> loadFinalizer()
    {
      try
      {
        Class localClass = newLoader(getBaseUrl()).loadClass("com.google.inject.internal.Finalizer");
        return localClass;
      }
    ...
    implements FinalizableReferenceQueue.FinalizerLoader
  {
    public Class<?> loadFinalizer()
    {
      try
      {
        Class localClass = Class.forName("com.google.inject.internal.Finalizer");
        return localClass;
      }
    ...
    implements FinalizableReferenceQueue.FinalizerLoader
  {
    ...
    public Class<?> loadFinalizer()
    {
      ...
      //   22: areturn
      //   23: astore_1
      //   24: invokestatic 34	com/google/inject/internal/FinalizableReferenceQueue:access$000	()Ljava/util/logging/Logger;
      //   27: ldc 36
 ...
 * Qualified Name:     com.google.inject.internal.FinalizableReferenceQueue
