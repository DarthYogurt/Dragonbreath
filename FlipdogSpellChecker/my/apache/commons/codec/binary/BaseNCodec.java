  ...
  implements BinaryEncoder, BinaryDecoder
{
  ...
  private byte[] defaultSizeBuffer;
  ...
  protected BaseNCodec(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (int i = paramInt2 * (paramInt3 / paramInt2); ; i = 0)
    {
      ...
      this.defaultSizeBuffer = new byte[getDefaultBufferSize()];
      return;
    }
  }
  ...
  private void resizeBuffer()
  {
    if (this.buffer == null)
    {
      this.buffer = this.defaultSizeBuffer;
      this.pos = 0;
      this.readPos = 0;
      return;
    }
 ...
 * Qualified Name:     my.apache.commons.codec.binary.BaseNCodec
